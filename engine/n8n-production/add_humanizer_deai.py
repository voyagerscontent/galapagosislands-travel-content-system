...
RECON_PROMPT = (
  ...
  "HARD RULES:\n"
  "• Each paragraph's 'reasons' field lists the EXACT AI tells a detector found in it "
  "(e.g. 'TIER-A lexical AI tells: unpack×4, landscape×1'). You MUST remove every single word "
  "and phrase named there — replace each with a plain, natural alternative in Juan's voice. "
  "These are banned even though Juan sometimes uses them: the point is to strip AI traces.\n"
